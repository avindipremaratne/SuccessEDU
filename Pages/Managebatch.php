...
var expires=86400;
 ...
 window.location.href = "updatedeletebatch.php";
 //alert(document.getElementById("myTable").rows[x.rowIndex].cells[0].innerHTML);
...
<?php 
//RESULT PAGE
$result=mysqli_query($con,"SELECT * FROM batch where Name='".$_POST["cmbcourse"]."'");
if(!$result)
{
...
{	
	...
	echo "<tr>";
	echo "<th align='center' id='reg' > Batch Index";
...
echo "<td><input name='mngstd' type='button' value='Manage Batch Details'/>";
	echo "</tr>";
}
	echo "</table>";
}
